...
A few example WAV files produced by each of our models is included in the "nesm_examples" folder to illustrate the resultant performance for each of our models. Also included in this folder is an original NES soundtrack from Zelda 2 to compare against.
