...
def train_model(model, dataset, val_dataset, 
                ...
                checkpoint_prefix = None, save_step = None):
    '''
    ...
    checkpoint_prefix : string
        Filename for saving model checkpoints.
    save_step : int
        Interval specifying the number of epochs between each instance we
        save our model weights using the given directory
    ...
    for i in range(epochs):
        ...
        # Save model weights
        if checkpoint_prefix and save_step and (i+1) % save_step == 0:
